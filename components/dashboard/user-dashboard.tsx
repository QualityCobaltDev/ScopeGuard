    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <form onSubmit={saveProfile} className="rounded-2xl border border-border bg-card p-6 space-y-3">
          ...
          <input className="w-full rounded-lg border border-border bg-background px-3 py-2 text-muted" value={user.email} readOnly />
      ...
      <div className="flex items-center justify-between rounded-2xl border border-border bg-card p-6">
        ...
        <button className="rounded-lg border border-border px-3 py-2 text-sm" onClick={logout}>Sign out</button>
      </div>
